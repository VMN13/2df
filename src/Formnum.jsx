...
export default function FormNum() {
  ...
  return (
    <div className="text-bold mx-10  text-red-800 text-2xl">
      <div className="flex justify-evenly">
        <p className="line-through">{oldPrice}</p>
     
        <p>{oldCurrency}</p>
      </div>
      <img className="rounded-full " src={Berry}></img>
    <form className="w-80">
  <label>
 
    <input type="text" name="name" placeholder="Ihr Name" />
  </label>
  <input className="w-80 rounded border-solid border-2 border-red-800" type="submit" value="WEIGHT BERRY BERRY BESTELLEN" />
</form>
    <PhoneInput
...
Mit Unterstützung:
    ...
    <div className="mx-10 grid grid-cols-2 grid-rows-4 gap-7">
   <img src={OnePng}></img>
   <img src={TwoPng}></img>
   <img src={ThreePng}></img>
   <img src={FourPng}></img>
   <img src={FivePng}></img>
   <img src={SixPng}></img>
   <img src={SevenPng}></img>
</div>
      </div>
